...
// 向量的叉积 GLfloat
void dsCross3fv(const GLfloat v1[3], const GLfloat v2[3], GLfloat ret[3]) {
	ret[0] = v1[1] * v2[2] - v1[2] * v2[1];
	ret[1] = v1[2] * v2[0] - v1[0] * v2[2];
	ret[2] = v1[0] * v2[1] - v1[1] * v2[0];
}
...
void dsNormalVectorOfTriangle3fv(const GLfloat p1[3], const GLfloat p2[3], const GLfloat p3[3], GLfloat ret[3]) {
